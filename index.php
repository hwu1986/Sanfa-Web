		...
		<div class="border main-content">
			<div id="id_home" class="text">
				...
				<div class="home center">
					<p><center><h2>Welcome to San Fa Construction Supply</h2></center>
						...
						<tr>
							<td valign="top" style="width:150px">
								...
								<div class="address">
									...
									Corozal Town, Belize<br>
									Tel: 501-422-0021<br>
									<a href="mailto:sales@sanfa.bz">sales@sanfa.bz</a><br>
								</div>
							</td>		
							<td valign="top">
								<div style="padding-left: 20px;">
									<h3>What we do</h3>
									<p>We specialize in construction materials and curtain doors.</p>
									<ul>
										<li>Cements and Steels</li>
										<li>Electric Supply</li>
										<li>Plumbing Supply</li>
										<li>Various kind of windows and doors</li>
										<li>Construction Blocks</li>
									</ul>
									<p>We also do consultation for people who plan to build their vacation home in Belize</p>
									<ul>
