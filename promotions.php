...
<html>
<head>
	<title>San Fa Construction Supply | Promotions</title>
	<!-- Javascripts -->
	...
	<!-- Metadata -->
	<meta name="description" content="Signup with our mailing list to get exclusion promotions from SanFa Construciton Supply." />
